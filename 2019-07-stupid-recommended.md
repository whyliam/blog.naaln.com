...
tags:
  ...
  - DataPrivacy
  - Platform
description: 信息流平台普遍使用推荐算法，用户常抱怨推荐差。三大问题出现：重复推荐因用户容忍度差异；推荐频次无法控制，算法难以区分短期兴趣与长期需求，易受标题党影响导致过度推送；隐私推荐在清空历史或购买敏感商品后仍会泄露，造成尴尬。
---
...
同样的场景还有，这个标题真是 low，进去看一下这篇东西讲的是什么，看完觉得什么垃圾文章。下次出现这样的文章，用户又被标题吸引点了进去。然后又一遍一遍的再加强推荐算法的理解。
