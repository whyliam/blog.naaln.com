...
tags:
  ...
  - 产品经理
  - 熵
description: 高利润守恒定律说明模块化和货品化在价值链上重新分配利润，导致相邻阶段出现专利性产品聚集；产品经理需要适应基于概率分布的产品，分离确定与不确定部分，重新设计测试流程，并面对岗位边界模糊与职能整合趋势；行业熵值加速提升，新技术带来更多选择与混乱，平台通过聚合用户与供给形成熵牧者，实现价值捕获，如谷歌、亚马逊、奈飞、优步、爱彼迎及国内内容平台等案例。
---
