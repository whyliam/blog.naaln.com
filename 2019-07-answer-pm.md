...
tags:
  ...
  - Strategy
  - UserExperience
description: 刘飞在问答中分享产品经理成长经验：提升能力需快速迭代配合导师并复盘；大厂偏专精，小厂需更广技能；硬件产品视领域差异；强业务导向产品应深度参与业务决策；捕捉用户痛点需走出办公室实际接触用户；自学成长凭实际手段提升格局；最佳产品经理需极高自我认知和社会责任感；核心取舍依赖用户与业务认知；需求可见关键在于实现用户价值与商业逻辑自洽；创业驱动力是想完成成事而非仅凭想法，需认清完整步骤。
---
...
**问：如何更准确的把握用户痛点？毕竟大部分产品是坐在办公室里意淫下沉城市的用户需求。**
...
答：这是产品经理的核心能力，确实不是一两句话能够说清的。。。如果真要抽象，那就是通过用户认知和业务认知做取舍。
