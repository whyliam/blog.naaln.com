...
tags:
  ...
  - SystemsThinking
  - LongTermism
description: 产品思维要求技术艺术化和产品化，细决定成败。内部项目、布道和社交媒体提升影响力。快速成长需兼顾长期与短期，持续积累、每日学习并坚持原则。保持长期动力的方法包括发布成绩、习惯日志、报名马拉松、设定身份并设想成功后场景，积累、专注与取舍是关键。
---
...
- 但这种细节需要多年的积累才会形成。这是一个二八定律：我们用两分的时间就会让一个东西看起来像那么回事，但却需要八分的时间把它打磨成精品。这当然还适用于一个产品，这八分时间填补的虽然只是20% 的差异，但却成为一个产品的核心竞争力，这可能就是所谓的「底蕴」的来源，所谓的「细节决定成败」-- 某同事
