...
tags:
  ...
  - Workflow
  - ToolPhilosophy
description: 用户从Pocket和Evernote转向flomo学习笔记法，卡片笔记法难以落地，后改用Obsidian配合Memo插件满足信息输入整理和任务管理需求。放弃flomo因非本地化管理、有仪式感、信息管理单薄等因素，虽设想改进方案但承认非目标用户，工具选择从排斥All-in-One到接受Obsidian的观念转变过程。
...
3. 信息管理过于单薄
flomo 的网页版体验让我感觉是在做信息的检索，而不能够完成信息整理；Obsidian 好歹有个客户端。
