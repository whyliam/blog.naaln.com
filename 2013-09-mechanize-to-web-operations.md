...
c1 = form.checkboxes[0].name
val2 = form.checkboxes[1].value
false = form.checkboxes.name("c1").checked
```
...
xk3 = form.fields.name('select1').value
xk3 = form.fields.name('select1').options[2].select
```
