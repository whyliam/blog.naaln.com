...
tags:
  ...
  - Learning
  - DigitalGarden
description: 知识是用于生产的有意义信息；知识管理包括获取、记录、利用三步；需规划范围并筛选有价值信息；采用Zettelkasten卡片盒笔记法的原子化、独立性、链接等原则进行记录；强调链接、注释、自己的想法和原始来源；利用阶段尚未完善，待补充。
---
...
2. 獨立性：一則記事即使獨立也能夠被看懂，意味著每一則記事都可以被單獨移動、處理、與其它記事合併。
