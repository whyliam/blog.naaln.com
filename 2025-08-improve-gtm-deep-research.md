...
tags:
  ...
  - 信息整理
  - 报告撰写
description: 探讨如何通过人工智能中的「深度研究」功能，提升市场营销（GTM）项目的效率与质量。深度研究能够快速处理复杂任务，节省大量时间并生成高质量分析报告。分享托尔斯滕·瓦尔鲍姆关于优化深度研究的实用方法，包括指定高质量数据源、提供定制化上下文、优化报告格式以及撰写高效的Prompt策略，帮助读者在实际工作中更好地应用AI工具，实现数据驱动的市场决策。
---
