...
tags:
  ...
  - 问题类型
  - 解决方案设计
description: 好的公众表达以帮对方解决问题为出发点，建立互利共赢。单方面要求行动收效甚微，应清晰告知对方采取行动的好处。说服力是对方对演示的认可程度，分阶段且流畅的逻辑促使对方自然转变并接受观点。需确定对方面临的问题类型并匹配叙事方法：恢复原状型叙事对应把握现状、控制损失、查明原因、根本措施与防止再度发生；预防潜在问题型叙事聚焦设想不利情况、查明诱因、制定预防策略与应对预案；追求理想型叙事围绕盘点家底、确定理想
---
