...
tags:
  ...
  - KnowledgeManagement
  - SystemDesign
description: GTD是一种行为管理方法，作者使用OmniFocus进行任务管理，划分Misc、Work、Learning、Life、Hobby、System等项目，并通过Energy、优先级紧急、schedule、项目标签等分类，利用收件箱、项目、标签、预测、检查、TO-DO、Today、Routine等透视视图。为快速输入任务，使用Alfred工作流实现todo命令并支持due、estimate、contex
---
...
每日截取昨日完成的项目，并保存到 Evernote。

**[周报/月报：](https://github.com/whyliam/hazel-script/tree/master/OmniFocus)**

每周/月截取上个周期完成的项目，并保存到 [TaskPaper](https://www.taskpaper.com/)
