...
我一直想要一个数据来验证我的假设，但是找不到这样的一个数据源，以下内容源自我的凭空臆想。
...
用户在社交软件上的更替，也有类似于工具型的软件的周期性变化——只是这个变化的周期更加的长久，6 - 10 年。（最近各大厂商在社交上的动作异常的明显，包括腾讯自己也出了 3、4 款软件来衔接后微信时代。而且，包括腾讯，微博，头条在内的新社交产品的切入点都是以年轻用户为切入点。）
...
QQ 时代向 微信 时代的迁移，借助了移动端和 3G 的发展，同时也正好打破了原有的用户关系；在微信 10 周年之际，伴随着 5G 时代的到来，腾讯是否还能完成自我的革新。
