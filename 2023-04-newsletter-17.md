...
tags:
  ...
  - DecisionMaking
  - Observation
description: 人类相较人工智能拥有偏见、狭隘与认知缺陷的优势，指出深度注意力正被超注意力取代，导致倾听、创造、强烈情绪、消极做事、真实友情与真实自我的缺失，呼吁在重大事务中避免等靠要的弱势文化，主动承担决策责任。
---
...
在更早流行起来的 AI 绘图或者说「炼丹」中，用户更早的意识到了这一点。尽管 Midjourney 的画技令人惊叹，但你往往需要锚定某种特定的画风或某个特定的画家，它才能表现的更好。在可以通过安装 lora 包来扩展不同风格的 Stable Diffusion 里，什么包都装只会让结果变得一团糟，将其绘画能力限制在仅符合本次绘画的主题，反而会获得更好的效果。
...
- **我们失去有力的情绪：**连续不断的刺激，让我们的情绪变得淡化，我们很少愤怒，而变成了不爽（比如微博的热榜）；我们不再恐惧，偶尔悲伤。（比如李医生周年）。而缺少这种浓烈的情绪，导致我们无法中断一种状态，开始一个新的状态。想想现在职场上的压抑情绪，他并不会让你愤怒掀桌（虽然我干过），但是却无时无刻不在消耗着你，但又让你无法彻底鼓足勇气离开。
...
但并不要把上面的这些事情当做「问题」，因为这会让你马上去想办法「解决」，这就又陷入到了一种「过度积极」中。换个角度，把它当做一种「事实」，我们需要的是观察和相处。这里其实想推荐的是项飚最近在青年志上的一个访谈「[城市新穷人不是经济穷人，是意义贫困](https://www.notion.so/1dcd0326b50d4fe8b9f45c070809c84e)」。也提到了这种环境下，我们该如何与其相处。
