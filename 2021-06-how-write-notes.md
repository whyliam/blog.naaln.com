...
tags:
  ...
  - 文献笔记
description: 
  文章阐述Zettelkasten笔记法的核心方法，将笔记分为短暂笔记、永久笔记和项目笔记三种类型。标准化流程包括六个步骤：制作短暂笔记记录灵感，撰写文献笔记用自己语言重新组织信息，生成永久笔记建立知识连接，通过链接创造笔记间联系，跟随兴趣扩展内容，最终发展主题形成线性文章。方法强调用完整句子陈述、提供参考资料，并通过不断思考笔记间关系来修正认知和产生新想法。建议不进行漫无目的头脑风暴，而是从笔记系
---
