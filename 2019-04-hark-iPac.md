...
tags:
  ...
  - 脚本
  - 破解方法
description: "iPic是支持多种图床的Mac订阅制软件，年费60元。文章介绍通过修改本地验证文件时间戳实现无限试用的技术方法。首先定位试用时间存储位置pl IST文件，将Markdown Flag的value设置为七天内时间戳可突破试用限制。为方便操作创建bash脚本在启动iPic前自动修改时间戳，运行脚本即可实现无限使用iPic所有功能，避免订阅费用。"
---
