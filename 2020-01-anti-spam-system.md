...
tags:
  ...
  - 移动应用安全
description: 
  日课APP反垃圾系统通过设备安全中心、行为监控中心、内容安全中心、举报中心和数据中心五个子系统构建完整防护体系。系统将spam内容分为内容、用户和行为三类，定义违背核心价值观的内容为spam但保持适度包容。系统目标是通过深度学习技术识别色情、推广、辱骂、违禁、涉政、灌水等垃圾内容，结合用户举报机制缩短攻击被检测时间并延长防御控制时间，确保社区内容质量和用户体验。
---
