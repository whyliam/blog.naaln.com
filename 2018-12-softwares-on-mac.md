...
tags:
  ...
  - DigitalGarden
  - Infrastructure
description: 在新装系统后，常用软件与工具的安装命令被列出，涵盖基础、生产力、设计、开发与娱乐等类别，提供完整的 macOS 软件清单。
---

由于公司的电脑硬盘换了，索性就把电脑格式化了重新安装系统。以下是我这次安装的软件，基本上可以满足日常的基本使用。如果还有需要安装的软件就之后再补充了。

由于我的日常主要设计开发和产品的工作，所以在软件上也主要是这两块。
