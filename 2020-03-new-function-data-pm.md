...
tags:
  ...
  - 职能转变
description: 
  数据产品经理分享岗位转换后的工作挑战和困惑。过去一直抢到数据产品经理需要技术背景，但在新工作中第一次对技术能力感到无力。团队配置齐全，包括PD、PM、UED、DP，开发出可以让PD快速实现分析型数据平台的系统，效率大幅提升但对数据PD要求极高，迷失在数百张数据表中。工作技能从只需了解PRD、MRD、Axure、Sketch扩展到需要思考数据库优化、计算引擎、资源融合、市场竞争、数据处理、计算资源分
---
