...
tags:
  ...
  - Writing
  - Workflow
description: 文章讲述个人知识管理的核心方法，强调通过信息收集、深度吸收、实践应用和知识分享四步流程，结合RSS、Evernote、Markdown等工具，帮助读者构建知识体系并创造价值，提升个人核心竞争力。
---
...
腾讯出品，在 PC 和手机都有相应的软件，上传速度还是挺快的，容量有 10T。我已经将常用的文件、软件和自己所有的图片上传到微云了
...
> 你可以根据你自己的情况选择相关的方法。所以有了这些大家共同积累下来的方法论和模式，再给你一张地图的时候，你不一定按照常规的学习路线走，你可以在方法论和模式的指导下创造出更多的行走路线，你要做的是根据自己的技能特点和面临的场景，选择最适合自己的学习路线。
...
[10] 人月神话：[我理解的知识管理层次](http://blog.sina.com.cn/s/blog_493a845501000cbl.html)
