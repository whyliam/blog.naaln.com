...
tags:
  ...
  - 文献分析
description: 
  我会系统性地指导如何阅读科学论文。首先识别作者机构声誉和期刊可信度。然后从导言入手找出研究领域的大问题，总结背景并明确具体研究问题。接着详细阅读方法部分，为每个实验绘制图表并深入分析结果数据，注意统计显著性和样本大小等关键细节。随后独立解读实验结果是否回答了预设问题，再阅读作者结论并质疑其合理性。最后回到摘要进行对比验证，并搜集其他专家的观点进行全面评价。
---
