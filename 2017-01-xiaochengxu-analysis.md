...
tags:
  ...
  - Observation
  - Strategy
description: 约四百个小程序的名称、分类和描述表明，最受欢迎的名字是xx助手、计算器、汇率；工具类小程序占比最高，生活服务次之；描述关键词为程序、提供、服务、信息、查询、工具、生活；出行、美食、金融、工具、效率、教育、生活、休闲、资讯、购物等十个类别榜单位居前十。
---
...
我分析了大约 400 个小程序，得到了一些数据：

## 最喜欢用的名字

![](http://pics.naaln.com/blog/2019-01-14-032054.jpg-basicBlog)

小程序里最多的名字是 `xx助手`，`计算器`，`汇率`。

可以直接反映为 计算器，和 汇率 的产品最多。
...
我认为工具类的产品正在小程序中越来越多，并且越来越贴近人们的生活。
