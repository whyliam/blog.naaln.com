...
tags:
  ...
  - Metrics
  - SystemsThinking
description: 数据衡量体系包括核心目标、数据收集渠道、反馈指标和执行变化，帮助解决业务需求、推动决策。体系通过量化数据在产品生命周期中发挥作用，需明确目标、选择合适渠道并建立数据筛选机制以确保数据有效性。应用覆盖电子商务、APP和金融等场景。
---
...
关于为什么要建立数据衡量体系，这里就不再叙述，数据化时代，好像不搞点数据出来亮一下，很多事情自己都要怀疑，更别说你那可爱的老板了——那么，在这里，我们主要来说一下数据衡量体系中的一些相关指标。
...
关于数据收集渠道这一块涉及到的比较广，基于不同项目的需求，数据的来源是多样性，在项目的实际操作中，可以根据目标指标需求对相应渠道进行数据埋点。当然，部分互联网产品涉及的数据收集来源也可以是：百度统计、友盟等。
