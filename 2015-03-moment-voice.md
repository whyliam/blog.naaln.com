...
tags:
  ...
  - 微擎
description: 
  近期微信朋友圈语音功能火爆网络，作者调查发现该功能并非腾讯官方发布，而是名为微裂变的第三方网站通过微擎开源系统模拟实现。该网站使用微信开放平台SDK的录音播放、隐藏菜单、扫码分享等功能制作出逼真的朋友圈语音界面，具备自动播放、分享传播等特性。虽然模拟度高，但需要在第三方页面收听语音，体验较差且存在信息安全风险。
---
