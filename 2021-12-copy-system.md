...
tags:
  ...
  - 界面设计
  - 用户引导
description: 文案分类为结构展示、操作类、提示性、解释说明、引导性、宣导类六种。结构展示文案考验命名准确与一致性。操作类文案确保用户预期与操作结果一致，避免误操作。提示性文案传达状态变化与建议，强调人性化表达。解释说明文案简洁补充信息说明。引导性文案促进用户执行动作。宣导类文案展现吸引力引导用户达成目标。六类文案分别考验准确性、明确性、人性化、简洁性、引导性、吸引力。
---
