...
tags:
  ...
  - 系统集成
description: 
  RPA是用于与界面元素交互完成重复性基于规则任务的通用工具，BluePrism于2001年创造该术语以区别于传统BPA软件。RPA重要性体现在四个方面：支持远程劳动力并降低后台运营成本高达70%；解决系统集成差距，自2017年企业平均运行464个自定义应用，Microsoft365现已拥有45个应用；通过计算机视觉实现远程桌面自动化；作为外包替代方案，劳动力套利红利已见顶且外包仍需持续监督。RPA
---
