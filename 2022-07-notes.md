...
tags:
  ...
  - Writing
  - ProductThinking
description: 作者回顾十年笔记软件使用历程，从Evernote主力到尝试OneNote、Flomo、Obsidian、Notion、语雀等替代方案。Evernote因设备限制和网络问题使用频率降低，OneNote块状记录方式不满意，Flomo理念认可但无明显优势，Obsidian卡片笔记法未形成有效叙事，Notion数据库功能用不到，语雀标准文档类记录与想法记录不匹配。寻求最适合的笔记工具替代方案。
---
...
为了替换 Evernote 尝试使用了 OneNote，但是它块状的记录方式一直让我喜欢不起来。
...
因认可 Flomo 背后的理念而使用它，但是相较于普通的笔记软件没有明显的突出点。
...
语雀的产品理念偏标准文档类记录，日志性的内容我已经在 blog 记录，想法类的信息用语雀有点杀鸡用牛刀的感觉。
