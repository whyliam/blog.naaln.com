...
tags:
  ...
  - Media
  - Observation
description: 机器写稿已在国内体育、娱乐、新闻综述等领域落地，采用结构化数据生成与自动摘要两种技术；国内代表如小明星、小南、阿同等机器人产出数千篇稿件，阅读量达千万；未来将扩展至行业报告与发言稿，强化情感表达与深度推理。
---

## 机器写稿背景与现状

在几年前，国外就已经启用了智能机器人的写稿系统，并且已经为外文媒体提供了上千篇的文章。最著名的公司有三家 ARRIA、AI、NARRATIVE SCIENCE。

但是国内的汉语语义复杂，语言处理一直处于摸索阶段。很多媒体需要和学术机构合作才可以取得一定的成果。国内在这一方面比较领先的有微软、百度、腾讯、今日头条，他们利用大量的新闻稿做语言训练，试图创作一些符合语义的新闻。
...
机器人还缺乏情感表达，之后将会训练主观意见在文章中的体现。比如「中国队大胜韩国队」或者「中国队惜败韩国队」的语句。它将更加人性化。
