...
tags:
  ...
  - Automation
  - Engineering
description: 面向前端初级新手，分享工作流程优化经验。内容包括引入基于Sass和typo的项目框架ysass，推荐SublimeText及Emmet和Sftp插件，详述浏览器兼容测试包括Chrome和Firefox，总结改进流程如使用实时预览工具提升开发效率。
---
...
别告诉我你没有接触过 Sass，你难道不知道在 Sass 中直接写 CSS 也是可以的么？再有，有
