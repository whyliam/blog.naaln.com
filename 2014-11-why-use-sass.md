...
> ——作者：[DAN CEDERHOLM](http://alistapart.com/author/dancederholm) ——译者：[若强](http://www.deanishe.net/alfred-workflow)

小提示：我们很高兴为你提供一个摘录，它是由 Dan Cederholm 写的一本叫做 [Sass For Web Designers](http://www.abookapart.com/products/sass-for-web-designers) 的书。你可以快速在一个叫 [A Book Apart](http://www.abookapart.com/) 的书城找到它们。

我对 Sass 略微有点抵触，我更喜欢直接写 css 样式！我不需要使用它！此外，我确实不想给我的工作流程中增加额外的复杂的部分，因此我选择远离它。

* * *

这就是我们的常规想法，但是 Sass（以及其他 css 预处理程序）确实是一个强大的工具，它可以让任何形式的样式都能够方便的引入开发工作中去。虽然他会花费我一些时间去熟悉、适应，但是我依然很乐于这样做。
...
现在，让我来向您展示如何让 Sass 不干扰你的工作流程，以及如何让您的工作更便利。下面，我将演示 Sass 的各个方面：怎样安装，怎样使用以及在项目中怎样提供给我们最大的帮助。但愿你将也会像我一样深深的爱上它的。
...
你也许听过不重复原则，它是由 Andy Hunt 和 Dave Thomas 在他们所著的一本叫《[程序员修炼之道](http://bkaprt.com/sass/1/)》的书里所定义出来的。据不重复原则的描述：
...
通过一篇 CSS 发明者们所写过的文章，我们可以略微了解到， 这些年来 CSS 的一些语法局限 (请参看的 Bert Bos 所写的一些 [论述](http://bkaprt.com/sass/3/))。
...
幸运的是，有许多其他选择可以帮忙解决我们所遇到的问题。其中 sass 就是一种。
...
你可以在 [Sass 网站](http://bkaprt.com/sass/4/) 上看到 sass 怎样描述它自身的简洁性的。
...
当然了，我时常还是仍然能够在一些网络媒体渠道了解到一些人对他还是产生怀疑的。让我们来消除对它的一些误解吧。
