...
tags:
  ...
  - Optimization
  - SystemsThinking
description: 数据科学家兰迪·奥尔森运用寻找《Where's Waldo》中主人公的遗传算法，计算出经过美国48个州及华盛顿特区和加利福尼亚州共50个目的地的最优公路旅行路线。该算法通过计算少数解决方案并选取最佳方案进行迭代优化，最终生成包含大峡谷、阿拉莫、弗农山等著名景点的完整路线图。理论上不间断驾驶需9.33天完成，全程实际安排建议需要两至三个月时间。奥尔森同时创建了美国获奖城市地图路线图，展现了数据科学在
---
...
在探索新闻主编特雷西的催促下，奥尔森开始寻找一条最快行驶路线，路线将经过所有 48 个州的国家自然地标，国家历史遗址，国家公园和国家纪念碑。同时还包括华盛顿特区，又在加利福尼亚州增加了一个地方，总共 50 个目的地。这里是途径：
...
其结果是这个 [路线图](https://randalolson.com/2015/03/08/computing-the-optimal-road-trip-across-the-u-s/)，其中包括停止在大峡谷，阿拉莫，弗农山，雅园，白宫，自由女神像，等等。您可以在任何一个州出发，并按任意方向行驶。
