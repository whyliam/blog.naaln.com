...
tags:
  ...
  - ValueCreation
  - Observation
description: 祝贺任子威千米短道速滑金牌和苏翊鸣坡面障碍银牌，作者因未在少年取得佳绩而焦虑。近年关注区块链但趋势晦涩，区块链、加密、NFT、元宇宙、Web3概念明确但看不清后续。夜追NFT白名单被骗后更冷静。作者坚持产品应产生价值，认为区块链和加密有价值，虚拟币、NFT无价值，元宇宙、Web3是未来互联网期待，实现颠覆需时间。区块链效率低是网络挑战，若要颠覆需出现必须降低效率商业场景，隐私或安全需求，非NFT。
---
...
从区块链、加密到 NFT、元宇宙，又到了 Web3。虽然，单独拿出每个都清楚，但是就看不清后续的发展轨迹。
...
目前区块链对当前网络最大的挑战是效率，去中心化的极大地降低了数据交互。而当前 WEB2 头部的公司都是提高了用户的使用效率，降低用户的使用门槛。比如，阿里巴巴的支付，腾讯的通讯。
