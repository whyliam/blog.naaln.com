...
tags:
  ...
  - Monetization
  - Platform
description: 互联网产品变现方式主要分为广告和交易两种，其中可细分为广告变现、电商变现、增值服务变现、内容变现、游戏变现五种模式。广告变现通过展示广告获取收入，需要平衡用户体验；电商变现包括B2C自采自销、C2C平台撮合、B2C2C导流分成三种模式；增值服务变现提供常规服务外的付费功能；内容变现依靠创作者产出内容获取收益；游戏变现通过销售游戏道具实现商业化，每种模式都有其独特特点和发展策略。
---
...
电商变现简单来说，就是卖货。但是电商变现也要讲究定位。电商模式，一般分为 B2C、C2C、B2C2C。B2C 代表就是京东商城模式，自己采购商品销售给用户。C2C 就是产品作为中介，商家来上架销售，用户来自己购买。B2C2C 其实就是淘宝客模式，嵌入一些电商平台信息给商品导流获取分成。
...
游戏变现一般主要形式就是游戏中的道具销售。很多用户玩游戏买道具都形成了习惯，用户沉寂在游戏中时也很容易产生消费，王者荣耀作为国民手游 2018 年营收 130 亿人民币，不得不感叹游戏的变现能力强。游戏变现虽然用户接受度高，但是游戏的推广成本现在却是水涨船高，想要游戏变现也要平衡好买量的 ROI。
