...
tags:
  ...
  - 时间管理
description: 
  作者长期使用Surge却未付费破解，心中不安。考虑购买五个许可后觉得值得，敬佩独立开发者的工作。先前曾手动屏蔽验证模块，现在实现自动化屏蔽，使启动全程自动化，感觉本周投入时间不符成本。因电脑使用不当和硬盘损坏，花费大量时间备份、维修、重装系统，最终提醒需花钱的地方尽量别花时间。最后列出若干IP地址用于参考。
---
