...
tags:
  ...
  - Workflow
  - AI
description: 从创始人Ivan Zhao的学习与创作起步，梳理Notion从站点Demo到0.5文档编辑器、1.0轻量Wiki、2.0数据库实现All‑in‑one演进，汇总融资与估值、用户与收入，展示模板市场与社区大使驱动增长、定位文档/Wiki/项目管理替代策略，分析AI、工作流、跨平台整合前景，并追溯Engelbart、Kay、Nelson理论根基，阐述其作为‘思维工具’的核心价值及在中国网络、付费、生态
---
...
大学毕业后，身边聚集了很多的艺术家朋友，他们有展示作品的需求，但是不会编程。
...
在它的 Early Access 网页上，我们看到了 ToDo、看板、代码块、附件、协作评论等功能雏形。与最初的 Demo 相比，它更直观、更易用、也组织得更有条理。
...
Notion 获得了 2016 年度 Product Hunt 最佳桌面端产品的提名。
...
- 2021 年 6 月，Notion API Beta 版发布，整合了多个 SaaS 工具，方便开发者在 Notion 中接入支付系统和客户管理系统；
...
随后当有新用户被 Notion 吸引而来，它立刻就能搬出一套非常丝滑的新手登录指南，确保每个人都能立刻找到最适合自己的那几套模板，最快地感受到 Notion 所能给予的价值。
...
**再聊下 Productivity 工具赛道**

前面的故事都发生在 AI 之前，在 AI 大潮下，又涌现出了很多生成工具类的产品。
