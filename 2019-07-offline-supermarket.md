...
tags:
  ...
  - Data
  - Strategy
description: 电商市场现状及发展趋势分析。拼多多以农村包围城市策略占据三四线消费市场，电商呈现红海竞争态势。线上消费存在目的性明确和目的性不明确两种模式，传统电商满足明确需求，导购平台服务模糊需求。大数据在电商中规模化应用。线上电商正探索向线下迁移，无人购物店收集用户信息、记录停留时长、模拟试妆，实现自动结账。线下电商存在推荐系统更新慢、SKU不全等挑战，但适合精选商品优化和补充线上用户消费习惯。
---
...
大数据对于线上电商是一个规模级应用场景。没有一个电商公司没有大数据的支持。比如淘宝会知道，用户的年龄，性别，消费习惯，最近喜欢的的商品等等。很多人还喜欢在逛淘宝时候详细的产品说明，细致的产品咨询服务，用户的反馈等等。

目前的消费模式都是将线下的模式移到线上，有公司尝试过将线上模式移到线下吗？

其实无人购物店就是这样一个类型，只是目前的体验还达不到一个用户认可的消费习惯。

1. 用户进入的店的时候开始获取用户信息，比如年龄，性别，线上购物习惯
2. 走进货架的时候可以记录用户在各品类商品的停留时长，拿起商品的频率等
3. 在商品离开货架的时候开始显示商品的信息
4. 购买化妆品和服装的时候还可以模拟试妆（线下消费的有一个好处其实是真人试妆）
5. 结账环节可以离店自动结账，或者离店发货等等

当然以上的购物体验只能说是一个尝试，线下电商的最大的一个问题是推荐系统没有办法像线上场景一样实时更新，商品的 SKU 没有线上齐全。但是比较适合类似小米优品、网易严选的线下店做商品 SKU 的优化，和对线上用户消费习惯的补充。
