...
tags:
  ...
  - VisualDesign
  - DesignPrinciples
description: 介绍打造优秀网站的四大技巧：巧用JavaScript和jQuery等轻量技术替代Flash添加动画效果提升吸引力；注重设计细节保持风格统一提升用户体验；利用视频内容吸引浏览者并通过YouTube等平台进行搜索引擎优化；运用大字体和明亮色彩打造简洁大胆的设计风格帮助网站脱颖而出。
---
...
**易读：**当我刚开始做网站的时候，当时的趋势是用超级小的版式。很流行使用 Verdana 或 Arial 字体然后字体大小不超过 11 号。而现在完全不是这样了。我现在浏览网站，经常被巨大的标题和题目所吸引。
