...
tags:
  ...
  - AI模型
  - 中文搜索
description: "Immich是一个开源自托管的照片和视频备份系统，支持自动同步、AI智能分类、面部识别，是Google Photos的替代方案。介绍使用Docker Compose部署Immich服务，包括配置immich、Valkey和PostgreSQL，设置PUID/PGID权限。添加现有照片库为外部路径，使用immich-geodata-cn实现地理信息中文显示，切换到XLM-Roberta-Large-"
---
