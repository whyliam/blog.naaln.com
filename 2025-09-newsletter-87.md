...
tags:
  ...
  - AI趋势
  - 个人成长
description: 本期newsletter探讨了从「卖时间」到「建系统」的思维转变，强调通过构建可规模化复制的资产和系统来实现持续收益。文章深入分析了AI时代人机协作的新模式，以及如何运用「上下文工程」优化AI Agent性能。同时分享了实用工具和行业洞察，帮助读者在快速变化的技术环境中把握机遇，实现个人成长与财富积累的双重目标。
---
...
- **检索（Retrieve）：**此 策略强调按需从外部知识库、历史对话或工具输出中检索信息，而非将所有内容预先载入。这不仅包括传统的 RAG，也涵盖了更简洁的生成式检索，例如给予 Agent 基础的文件搜索工具，让其自主探索。Agent 的「记忆」功能，本质上也是一种针对历史对话的特定检索。
