...
tags:
  ...
  - QWERTY
  - 人机交互
description: 从iPhone小巧按键引发的疑问出发，文章梳理了全触控取代实体键盘的决策过程，阐释了Blob键盘的失败及保留QWERTY、每键单字、降低操作负担的关键教训。进而展示基于QWERTY的新方案如何通过智能联想、自动纠错、动态词库、点击评分与接触面积偏移等技术提升输入精度。最终强调以约束中创造自由的设计理念，实现看似反直觉却成功的用户体验。
---
