...
tags:
  ...
  - RetailStrategy
  - ConsumerInsight
description: 通过刘润演讲引入折扣MAMA案例，深度分析折扣业态的三种形态，重点探讨唐吉诃德的成功模式及背后原因。研究库存尾货生意的千亿赛道前景，分析传统尾货处理方案的效率问题和品牌损害。解析折扣MAMA的商业模式创新，包括2B端品牌方解决方案和2C端社区零售定位，强调社区模式能有效避免乱价问题，帮助品牌方开拓中老年增量市场。
---
...
这种临期尾货的生意，在我的印象中主要是快闪模式，比如年底清库存；或者是挂羊头卖狗肉，或是低价噱头，其实是主打白牌商品。
...
之前的尾货逻辑是，品牌方将尾货分割成几个单元（因为没有采购可以持续全部货），这批货会留给供应商，再到三方物流，再到门店，再到消费者。中间至少有 3 到 4 环的环节存在，最短的也要到三环。
...
> 「折扣 MAMA」前期就签下了宝洁，拿了宝洁的授权，保洁以每一个月或者每一个季度的形式把库存表格同步给「折扣 MAMA」，「折扣 MAMA」按照框架协议把这部分商品同步到达互相认可且肯定的渠道里去完成定向的消化。
