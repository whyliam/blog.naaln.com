...
tags:
  ...
  - PersonalProjects
  - Observation
description: 文章描述基于Saming的2048克隆版本介绍递归策略游戏，链接到演示演示。基本策略是严格遵循递归步骤如解九连环，避免随机移动键慎用向上和向右键防止数列错行，通过此方法玩家可稳定达成2048得分低但可继续挑战4096目标。
---
...
下图是一个游戏刚开始的例子，我只要在右下角合并一个 2，顶端数字就可以变成 32，然后我继续在顶端数字旁构造 16、8……
