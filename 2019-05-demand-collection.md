...
tags:
  ...
  - 产品经理
description: 
  阐述需求采集的关键在于识别背后逻辑而非表面需求，关注用户为何需要而非他们想要的具体功能；在需求管理中区分面向消费者面向企业等其他角色，考虑圈子竞争，并收集来源场景描述原因验收标准；运用卡诺模型评估需求价值，将电商搜索功能划分为基础型索引分类、期望型文字搜索和兴奋型语音与个性化推荐，以满足不同层次的用户需求。
---
