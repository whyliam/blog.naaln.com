...
tags:
  ...
  - Growth
  - ProductThinking
description: 移动应用市场图的实用设计方法详解：分析iOS和Android规范，基于七原则（首屏原则、亮点原则、简洁原则等）指导视觉呈现，展示六种常见样式（原生界面、截图加说明等），帮助设计师创作更吸引人的应用截图。
---
...
文章开始我们来说说应用市场图的名称，它既被叫作**市场图**、**应用市场图**，也有被称为**应用截图**、**上架图**等。所以当大家听到这几个名词时，就可以知道说的是什么了。
...
色彩心理学对于人所产生的影响这里就不做详解，有兴趣的朋友可以自行翻阅书籍，这里推荐《色彩心理学》《设计色彩》《FPA 性格色彩》等书籍，相信能对大家色彩搭配有所帮助。
