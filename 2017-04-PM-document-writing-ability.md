...
tags:
  ...
  - 商业价值
  - 需求分析
description: "三大文档分别阐述商业价值、市场需求和产品实现方法。BRD聚焦商业价值、成本估算和收益预算，采用文字、图表、思维导图呈现；MRD围绕市场分析、用户需求、产品功能，使用文字、图表、思维导图、流程图说明；PRD则细化实现方式、验收标准、用例、性能需求，配备文字、图标、流程图、草图、思维导图支持。"
layout: post
---
