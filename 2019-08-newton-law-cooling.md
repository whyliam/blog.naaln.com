...
tags:
  ...
  - Recommendation
  - Decay
description: 牛顿冷却定律描述物体与周围环境存在温度差时热量传递规律，单位时间散热量与温度差成正比。该定律可用于设计热门文章推荐算法，通过计算点击量、评论量、收藏量等指标的加权和得出初始热度，再应用指数衰减公式进行时间衰减。热度计算公式为本次得分等于累计点击量乘以指数函数exp(-at)，其中a为冷却系数，t为时间间隔。通过调整衰减参数可控制热度下降速度，使文章热度随时间自然衰减而非永久占据榜首位置。此算法同样
---
