...
tags:
  ...
  - 时间管理
description: 
  财富是能产生睡后收益的资产而非金钱本身；需摆脱对金钱的偏见，掌握社会需求的独门绝技；运用资本、劳动力以及零边际成本的软件和媒体杠杆；通过出色判断力而非时间驱动行动；摆脱单纯打工依赖，学会自我销售；创造并规模化有价值产品；保持耐心专注；用时间创造价值而非省时；寻找志同道合的伙伴；设定极高时薪并坚持执行；淡化贪欲保持原有生活方式；避免冒险违法失去自由与声誉。
---
