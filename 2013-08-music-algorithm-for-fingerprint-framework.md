...
tags:
  ...
  - Echoprint
  - 算法
description: 音乐指纹算法通过生成音频的唯一指纹来识别歌曲。Shazam算法利用星座图提取时间点的高能量频率，存储为hash对，手机片段生成指纹后比较匹配项的时间关系找匹配；Echoprint算法用带状图提取多频段高能点，计算时间差（IOI）组成hash，服务端直方图统计匹配次数选得分最高片段。
---
