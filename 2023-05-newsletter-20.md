...
tags:
  ...
  - Strategy
  - SystemsThinking
description: 阐述财富积累核心路径为拥有产权和使用三类商业杠杆资本、人力、零边际成本产品，强调独特知识获取重要性。提供快速理解新业务的方法论，包括产业链拆分、OKR目标对齐、行业平台研究和第一手信息获取。分析智能座舱产品经理职责，涉及用户交互场景、功能模块划分、自研外采策略，以及车内驾驶、非驾驶和车外场景的需求特点。提供从宏观到微观的业务理解和产品管理指导。
---
...
第二步就是按照供给侧到消费侧的顺序梳理核心流程，比如游戏就是从选品 ->内测 ->上架渠道 ->用户下载 ->登陆 ->支付，电商类似，从选品 ->采购 ->上架 ->商品详情 ->下单 ->支付，然后以此从宏观层面初步理解业务。
...
**3/研究该行业所有的平台**
研究所有的平台，先研究它本身有什么，赛道内有哪些是爆的，有哪些是波动的，同时一定要确认这个需求是不是伪需求，一定要真正跟消费者做好确认。总结一下也是大公司做产品的思路：行业分析 ->竞对分析 ->用户内测 ->跑 MVP
