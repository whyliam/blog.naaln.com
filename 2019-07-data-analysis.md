...
tags:
  ...
  - ProductThinking
  - SystemsThinking
description: 数据分析方法以解决业务问题为核心，步骤包括理解并定义问题、梳理分析框架、规范数据定义指标维度矩阵、规划分析方法确定度量可视化、最后输出报告确保专业高标准。
---
...
接下来基于分析框架，明确每一个分析问题，需要采用什么样的分析方法进行分析；详细写出分析的标题、度量内容、可视化方法、分析方法，并按数据分析报告（以 PPT 为例）展示的顺序组织。
